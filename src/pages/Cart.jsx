      ...
      <div className="w-full h-full max-w-[1280px] px-5 md:px-10 mx-auto py-[100px]">
        ...
        {products.length >= 1 ? (
            ...
            <div className="flex-[1]">
              ...
              <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
                <div className="flex justify-between">
                  <div className="uppercase text-md md:text-lg font- text-black">
                    subtotal
                  </div>
              ...
              <button
                ...
                className="capitalize w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-all active:scale-95 mb-3 hover:opacity-75"
              >
                clear all
              </button>
            </div>
          ...
          <div className="flex-[2] flex flex-col  items-center pb-[50px] md:mt-14">
            ...
            <Link
              to={"/"}
              className="text-white mt-8 bg-black px-4 py-2 rounded-lg hover:opacity-75 active:scale-95"
            >
              Continue shopping
            </Link>
          </div>
