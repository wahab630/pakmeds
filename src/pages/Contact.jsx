  ...
  const {
    ...
    validationSchema: Yup.object({
      ...
      price: Yup.number()
        ...
        .max(5555, "Price should be less than 5555$")
        ...
        <form className="md:w-[50%] w-[90%] " onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              id="title"
              name="title"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-red-500 dark:focus:border-red-500"
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              name="description"
              rows="4"
              className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-red-500 dark:focus:border-red-500"
          ...
          >
            <div className="flex items-center justify-center">
              <svg
                ...
                className="w-10 absolute top-[50%] translate-y-[-50%] translate-x-[-50%] left-[50%] h-20 text-gray-500"
              >
            ...
            <div className="flex items-center justify-center">
              <span className="text-gray-500 absolute top-[50%] translate-y-[-50%] translate-x-[-50%] left-[50%]">
