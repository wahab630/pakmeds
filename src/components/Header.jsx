...
const Header = () => {
  ...
  return (
    <>
      <header
        id="header"
        className={`w-full h-[50px] md:h-[80px] bg-white shadow-md flex items-center justify-between fixed z-30  top-0 transition-transform duration-300`}
      >
        <div
          className={`w-full max-w-[1290px ] px-5 md:px-10 mx-auto flex items-center justify-between `}
        >
          <Link to={"/"}>
          ...
          <div className="flex items-center gap-2 text-black">
            ...
            >
              <BsCart className="text-[12px] md:text-[20px]" />
